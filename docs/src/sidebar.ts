...
export const uiSidebar: SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Avatar", slug: "ui/avatar", badge: cssBadge },
      ...
      { label: "Menu", slug: "ui/menu", badge: cssBadge },
      ...
      { label: "Separator", slug: "ui/separator", badge: cssBadge },
      ...
      { label: "Toolbar", slug: "ui/toolbar", badge: cssBadge },
    ],
  },
  {
    label: "Utilities",
