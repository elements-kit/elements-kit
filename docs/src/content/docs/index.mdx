...
- **Compose, don't install.** Small focused APIs — `signal`, `computed`, `on`, `fromEvent`, `async`. State, server-state, browser hooks, and UI all live in one toolkit.
...
<CardGrid>
  ...
  <LinkCard title="Philosophy" href="/getting-started/philosophy" description="Four principles behind the API — compose don't install, close to the platform, predictable and explicit, designed for the AI age." />
</CardGrid>
