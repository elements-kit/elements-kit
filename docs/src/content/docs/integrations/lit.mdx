...
## `PropsOf` as a type annotation

`PropsOf<I>` is useful when you need to describe the settable surface of an elements-kit element — for example, inside a factory or test helper:
