...
| large title, size `1` | 54px — one 30px line (`--font-size-6`, 24px), 16px above, 8px below | same |
| large title, size `2` | 60px — one 36px line (`--font-size-7`, 28px) | same |
