...
Add `data-layout="stacked"` to put the icon above the label. The geometry matches a [stacked button](/ui/button#icon-and-label): at size `2`, a 20px icon, a 4px gap, and a 12px medium-weight label on an 18px line, in an item at least 56px square.
