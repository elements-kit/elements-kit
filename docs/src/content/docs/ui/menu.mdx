---
title: Menu
description: A menu's content (items, trailing parts, labels and separators).
---

import StorybookEmbed from "@/components/StorybookEmbed.astro";

The content of a dropdown or context menu: items, trailing parts, group [labels](/ui/label) and [separators](/ui/separator). It's CSS only: keyboard navigation, typeahead and dismissal belong to the script or [overlay](/ui/overlay) that opens it.
