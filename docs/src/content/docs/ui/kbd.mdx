...
A small chip for keyboard keys in inline text — e.g. shortcuts in help, hint text, command palettes. Class + data-attribute API: one `.x-kbd` class plus `data-size`. Flat tinted background (`--base-color-a3`).
