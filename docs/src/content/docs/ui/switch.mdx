...
- **`surface`** *(default)* — bordered track, `--base-color-a3` off, `--accent-9` on. Layered thumb shadow for depth.
- **`soft`** — flat track, `--base-color-a3` off, `--accent-a5` on. Desaturated thumb. Less visual weight.
